...
<div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
  <img src="../../static/img/usage-guide/customer/로그인.png" width="300" height="550" />
...
<br/><br/>
<div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
  <img src="../../static/img/usage-guide/customer/메인페이지 - 빵집 및 빵 탐색.gif" width="300" height="550" />
  <img src="../../static/img/usage-guide/customer/빵 리스트 페이지 - 빵 탐색.gif"  width="300" height="550" />
...
<div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
  <img src="../../static/img/usage-guide/customer/빵집페이지 상세1.png" width="300" height="550" />
  <img src="../../static/img/usage-guide/customer/빵집페이지 상세2.png" width="300" height="550" /> 
</div>
...
<br/><br/>
<div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
  <img src="../../static/img/usage-guide/customer/빵 예약1.png" width="300" height="550" />
  <img src="../../static/img/usage-guide/customer/빵 예약2.png"  width="300" height="550" />
...
<br/><br/>
<div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
  <img src="../../static/img/usage-guide/customer/마이페이지 - 예약전체.gif" width="300" height="550" />
  <img src="../../static/img/usage-guide/customer/마이페이지 - 예약상세.gif"  width="300" height="550" />
...
<br/><br/>
<div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
  <img src="../../static/img/usage-guide/customer/빵 즐겨찾기.gif" width="300" height="550" />
  <img src="../../static/img/usage-guide/customer/빵집 즐겨찾기.gif"  width="300" height="550" />
...
<div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
  <img src="../../static/img/usage-guide/customer/알림 내역 조회.gif" width="230" height="423" />
  <img src="../../static/img/usage-guide/customer/개별 빵 알림 onoff.gif" width="230"
  height="423" />
  <img src="../../static/img/usage-guide/customer/방해금지 - 토글.gif" width="230" height="423" />
